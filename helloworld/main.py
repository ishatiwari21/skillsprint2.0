...
#
# cv2.circle(img,(400,400),50,(203, 192, 255),2)
...
import datetime as dt
#
# face_cap = cv2.CascadeClassifier("haarascade_frontalface_default.py")
...
while True:
    ...
    # cv2.rectangle(frame,())
    cv2.putText(frame, 'Isha', (40,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,0), 2)
    date_time=str(dt.datetime.now())
    frame=cv2.putText(frame,date_time,(10,50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),2,cv2.LINE_AA)
    cv2.imshow("Video",frame)
    if cv2.waitKey(1)==ord("q"):
